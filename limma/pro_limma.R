...
p1_input <- read.csv("p1_limma_export_pro.csv", row.names=1)
p2_input <- read.csv("p2_limma_export_pro.csv", row.names=1)
...
# Export the data
write.fit(p1_fit_cont_eb, p1_fit_cont_eb_decide, "p1_eb_fit_pro.tsv")
write.fit(p2_fit_cont_eb, p2_fit_cont_eb_decide, "p2_eb_fit_pro.tsv")